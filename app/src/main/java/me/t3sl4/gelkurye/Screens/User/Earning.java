...
import me.t3sl4.gelkurye.Model.Earning.EarningAdapter;
...
public class Earning extends AppCompatActivity {
    ...
    private ArrayList<me.t3sl4.gelkurye.Model.Earning.Earning> earningListTemp;
    ...
    private void getAllEarnings() {
        ...
        me.t3sl4.gelkurye.Model.Earning.Earning tempEarning = new me.t3sl4.gelkurye.Model.Earning.Earning( "23423423", "11.05.2024 20:32", 123.23, true);
        for(int i=0; i<8; i++) {
            earningListTemp.add(tempEarning);
        }

        me.t3sl4.gelkurye.Model.Earning.Earning tempEarningFailed = new me.t3sl4.gelkurye.Model.Earning.Earning( "23423423", "11.05.2024 20:32", 13.23, false);
        for(int i=0; i<7; i++) {
