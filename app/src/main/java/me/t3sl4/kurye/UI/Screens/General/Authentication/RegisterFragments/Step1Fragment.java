package me.t3sl4.kurye.UI.Screens.General.Authentication.RegisterFragments;
...
public class Step1Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        PasswordFieldUtil.setChangeablePasswordField(passwordEditText, view.getContext());
        PasswordFieldUtil.setChangeablePasswordField(passwordRepeatEditText, view.getContext());
