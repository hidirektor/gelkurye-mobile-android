package me.t3sl4.kurye.UI.Components.StateProgressBar;
...
public class StateProgressBar extends View {
    ...
    private boolean mStateNumberVisibility;
    private boolean mStateDescriptionVisibility;
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        mStateNumberVisibility = true;
        mStateDescriptionVisibility = true;
        ...
        if (attrs != null) {
            ...
            mStateNumberVisibility = a.getBoolean(R.styleable.StateProgressBar_spb_stateNumberVisibility, mStateNumberVisibility);
            mStateDescriptionVisibility = a.getBoolean(R.styleable.StateProgressBar_spb_stateDescriptionVisibility, mStateDescriptionVisibility);
    ...
    private void drawStateDescriptionText(Canvas canvas) {
        if (!mStateDescriptionVisibility) return;
    ...
    private void drawStateNumberText(Canvas canvas, int noOfCircles) {
        if (!mStateNumberVisibility) return;
